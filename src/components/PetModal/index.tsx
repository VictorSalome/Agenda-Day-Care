...
import { Modal, Box, Typography, Button, Grid, TextField, Stack } from "@mui/material";
...
const PetModal: React.FC<ModalProps> = ({ isOpen, closeModal, user }) => {
    ...
    return (
        <Modal open={isOpen} onClose={closeModal}>
            ...
            >
                <CloseIcon sx={{ position: "absolute", top: 10, right: 10, cursor: "pointer" }} onClick={closeModal} />
                <Typography variant="h5" component="h2" align="center" sx={{ marginBottom: 2 }}>{user.name}</Typography>
                ...
                <Button variant="contained" onClick={closeModal} fullWidth sx={{ marginTop: 2 }}>Fechar</Button>
            </Box>
        </Modal>
    );
};
