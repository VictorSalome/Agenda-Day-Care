                ...
                <>
                    ...
                    >
                        <Box p={5} textAlign="center" style={{ height: "100%" }}>
                            <IconButton sx={{ position: "absolute", top: 10, right: 10, color: "#000" }} onClick={closeAgendaModal}>
                                <CloseIcon />
                            </IconButton>
                            <div style={{ overflow: "auto", height: "calc(100% - 80px)" }}> {/* Adiciona a barra de rolagem */}
                                <Agenda /> {/* Componente do calendário */}
                            </div>
                        </Box>
                    </Modal>
                    <PetModalInfo isOpen={infoModalIsOpen} closeModal={closeInfoModal} user={user} />
                </>
            )}
        </Box>
    );
