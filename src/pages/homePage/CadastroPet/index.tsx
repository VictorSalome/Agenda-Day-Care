...
const AddDogForm: React.FC = () => {
    ...
    const handleInputChange = (
        event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement | { name?: string; value: unknown; type?: unknown }>
    ) => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-slate-900">
            <form onSubmit={handleSubmit} className="bg-white sm:p-6 md:p-8 rounded-2xl shadow-md w-full sm:w-5/6 md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto" encType="multipart/form-data">
                <h1 className="text-3xl font-bold text-gray-900 mb-4 text-center">Cadastro de Pets</h1>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControl fullWidth>
                            <InputLabel id="feedingFrequency-label">Frequência de Alimentação</InputLabel>
                            <Select
                                labelId="feedingFrequency-label"
                                id="feedingFrequency"
                                name="feedingFrequency"
                                value={feedingFrequency}
                                onChange={(e) => handleFeedingFrequencyChange(e.target.value as string)}
                ...
                <Grid item xs={12}>
                    <Button type="submit" fullWidth variant="contained" color="primary" style={{ marginBottom: '16px' }}>
                        Cadastrar Pet
                    </Button>
                </Grid>
            </form>
